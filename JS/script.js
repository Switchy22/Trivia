var pageContent = document.querySelector("#page-content")
    ...
    function gotQuiz(data){
        ...
        for (i = 0; i < 15; i++) {
            ...
            wrongAnswerEl.innerText = question.incorrect_answers;
            pageContent.appendChild(wrongAnswerEl)
            var correctAnswerEl = document.createElement("button")
            correctAnswerEl.innerText = question.correct_answer;
            pageContent.appendChild(correctAnswerEl)
            gotQuiz.splice(Math.floor(Math.random() * data.length), 1)[o];
